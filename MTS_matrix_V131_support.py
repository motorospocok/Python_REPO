...
def send_tcp_packet(packet_to_be_send):
    ...
    s.settimeout(None) #necessary to set it after test
    s.close()
...
def About():
    ...
    popup = tk.Tk()
    popup.wm_title("!")
    label = ttk.Label(popup, text="Version 1.31 - 2021 October 26", font="TkFixedFont")
...
if __name__ == '__main__':
    import MTS_matrix_V131
    MTS_matrix_V131.vp_start_gui()
