...
# It is required to have MTS_matrix_V3.py together
...
def check_matrix_status():
    ...
    while number < 24:
        ...
        object1 = eval(obj_convert)
        object1.configure(foreground=color)
        number2 = number2 + 1
        number = number + 2
    val = "ST"
    message1 = val.encode('utf-8')
    ...
    while number < 24:
        ...
        object1 = eval(obj_convert)
        object1.delete(0,2)
        object1.insert(0,str(z[number+1]))
        number=number+2
...
def About():
    ...
    popup = tk.Tk()
    popup.wm_title("!")
    label = ttk.Label(popup, text="Version 1.3 - 2021 October 26", font="TkFixedFont")
...
if __name__ == '__main__':
    import MTS_matrix_V3
    MTS_matrix_V3.vp_start_gui()
